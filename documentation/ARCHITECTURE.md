...
drift, the palette wanders and the corporate cover, contents and body structure is
...
[comparison table](#why-not-just-ask-an-ai-to-use-this-template).
...
[Structure-aware](#structure-aware-not-just-style-aware).
