...
| **Current release** | [v0.8.1](https://github.com/ferdinandobons/brand-docs/releases/tag/v0.8.1) alpha |
...
Latest release: [v0.8.1](https://github.com/ferdinandobons/brand-docs/releases/tag/v0.8.1). See [CHANGELOG.md](CHANGELOG.md).
